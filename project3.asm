...
message1: .word 180 4000 0 90 4000 0 180 11800 1 60 4000 1 40 2000 1 20 1600 1 0 1800 1 -20 1600 1 -40 2000 1 -60 3990 1 90 12500 0 270 1600 1 250 2520 1 225 2260 1 200 2800 1 180 1800 1 155 2800 1 135 2260 1 110 2520 1 90 1600 1 90 800 0 0 12000 1 90 5000 1 180 6000 0 270 5000 1 180 6000 0 90 5000 1 12
		#--------------------------------------------------------------------------------------------------------------------------------------------S----------------------------||---------||---------------------------------------------------o--------------------------------------------------||---------||--------------------I----------------------------||-------||--------------------------------------------------C----------------------------------------------||--------||----------------------T---------------------||
message2: .word 180 4000 0 90 6000 0 270 1200 1 256 1640 1 236 1440 1 207 900 1 180 800 1 146 1440 1 137 4100 1 150 1600 1 180 1200 1 207 900 1 225 720 1 233 1000 1 254 1460 1 270 1400 1 90 8400 0 76 1640 1 27 1780 1 0 1200 1 326 1440 1 291 1700 1 249 1700 1 214 1440 1 180 1200 1 153 1780 1 104 1640 1 90 4000 0 90 4800 1 270 2400 0 0 12000 1 270 2400 0 90 4800 1 90 7800 0 270 1600 1 250 2520 1 225 2260 1 200 2800 1 180 1800 1 155 2800 1 135 2260 1 110 2520 1 90 1600 1 90 3600 0 0 12000 1 270 2400 0 90 4800 1 12
		#-------------------------I---------------------------------------------||--------||--------L----------||--------||---------------------------------------------------o--------------------------------------------||------||-------------v----------------||---------||------------------------------------------------------------------e---------------------------------------------------------------------------||--------||--------------------------------------H--------||--------||---------------------------------U-------------------------------||--------||-------------------------------------S-------------------------------------------------------------------------||--------||-----------T--------------------
...
#--------------------------------------------------------
#--------------------------------------------------------
#Kiem tra xem gia tri nao duoc nhap tu key maxtrix
#Neu la 0,4,8 se cho ra cac postscript tuong ung
#Con lai thi khong xuat hien gi
#--------------------------------------------------------
Check: 
	polling:
